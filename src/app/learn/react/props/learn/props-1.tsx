  ...
  return (
    <div
      ...
      <div className='mt-6 sm:flex sm:gap-4'>
        <button className='mt-2 inline-block w-full rounded-lg bg-gray-50 px-5 py-3 text-center text-sm font-semibold text-gray-500 sm:mt-0 sm:w-auto'>
          Close
        </button>
      </div>
    </div>
...
const Container = () => {
  ...
  return (
    <div>
      ...
      {isVisible && <Notification title={title} count={count} />}
    </div>
  )
}
